...
// ── Icons ────────────────────────────────────────────────────────────
export const Icon = ({ name, size = 16, stroke = 1.6, color = 'currentColor', style }) => {
  const s = size;
  const common = {
...
// ── TopBar ───────────────────────────────────────────────────────────
// 用 NavLink 取代原稿的假按钮；active 由 URL 判定，外部 prop 仅作兜底
const NAV_ITEMS = [
  ...
  return (
    <div className="kb-topbar">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <NavLink to="/prefs" className="kb-btn ghost" style={{ width: 32, padding: 0, justifyContent: 'center', textDecoration: 'none' }} title="首选项">
...
// ── Source card ──────────────────────────────────────────────────────
export const VaultCard = ({ source, title, path, files, updated, summary, extra }) => {
  const srcMap = {
  ...
  return (
    <div className="kb-card" style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 10, position: 'relative' }}>
      ...
      {extra}
      <div style={{ fontSize: 13, color: 'var(--ink-sub)', lineHeight: 1.55, flex: 1 }}>{summary}</div>
...
// ── Section headers ──────────────────────────────────────────────────
export const SectionHeader = ({ source, title, subtitle, right }) => (
